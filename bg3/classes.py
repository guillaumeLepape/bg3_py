...
CLASS_UUID_NAMESPACE = UUID("d98c6807-8ead-4214-8747-01457155fd1a")


def class_uuid(class_: Class) -> UUID:
    return uuid5(CLASS_UUID_NAMESPACE, class_)
...
SUBCLASS_UUID_NAMESPACE = UUID("5460987c-945d-413f-bf20-0656d049279d")


def subclass_uuid(sub_class: SubClass) -> UUID:
    return uuid5(SUBCLASS_UUID_NAMESPACE, sub_class)
